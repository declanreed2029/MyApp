...
function App() {
  ...
  const Details = [
    {
      ...
      sections: [
        ...
        },
        {
          ...
          text1: '-During testing, I created a survey aimed at determinening consumer reactions to various methods of stimulus and housing our device and then did the subsequent data analysis of reasults. The results were used to deterimine the specifics of housing the device and led to the decisions that would be made on the final prototype. Said prototype was highly complimented by Doctors, the Project Partner, and other visting industry professionals.',
        },
        {
          heading: 'Our Product',
          text: '-Based on the ability to hyperventilate during episodes making detection both possible and accurate.',
          text1: '-Compatible with any Bluetooth capable microphone and headphone or earphone.',
          text2: '-The microphone captures breathing sounds and transmits them to an audio analysis software.',
          text3: '-This then processes the data using a Fourier Transform and can determine whether the breathing is hyperventilation or normal. This determination is based on breathing rate and volume thresholds, above which the breathing is considered abnormal.',
          text4: '-Initially the thresholds are determined through training sound samples that the user can upload, but they can be further adjusted and fine-tuned as required.',
          text5: '-If the software recognizes this breathing as hyperventilation it will send an audio stimulus to the headphones, waking the user up.',
          text6: '-The app serves as an interface allowing users to upload their own custom alarm sounds and breathing sound samples for training, in addition to customizing the sensitivity of the thresholds.',
        },
      ...
      side: [
        ...
        },
        {
          ...
          link1: "https://drive.google.com/file/d/18Bw24P5nm7e0kBfZrvfiUsROLntmgEnU/view?usp=sharing",
      ...
      sections: [
        {
          ...
          text2: '-Relevent coursework: Advanced Inorganic Chemistry, Physics for ISP, Design Thinking and Communication, Multivariable Differential Calculus, Principles of the Properties of Materials.',
          text3: "-Relevent Activities: Propulsion Team (Building Northwestern's first Liquid-Fueled Rocket)",
        },
        {
      ...
      side: [
        {
          ...
          text1: '-Certification in “Math for Data Science” - contained 6 courses.',
          text2: '-Certification in “Python 3”.',
          text3: '-Certification in “Feature Engineering” - contained 4 courses.',
          text4: '-Certification in “Introduction to Cybersecurity” - 1 course.',
      ...
      side: [
        {
          ...
          text1: 'Major: Mechanical Engineering with a concentration in Aerospace',
          text2: 'GPA: 3.7',
        },
      ...
      sections: [
        {
          ...
          text1: '-Managed and led other interns while the Director was sick, assisted visiting professors in operations.',
          text2: '-Co-Created a new inventory management system containing enhanced scalability and ability to easily retrieve data analytics.',
          text3: '-Created a database to house 3,000+ data points collected from various STEM Programs and compiled and organized the data analytics from that data. Database structure now used for future iterations of those programs.',
          text4: '-Worked on Python programs and installed and troubleshooted various Softwares.',
        },
        {
        ...
        },
        {
          ...
          text1: '-Co-Developed new flow for a Cloud Infrastructure Education Program.',
          text2: '-Co-Developed new marketing materials and strategies for STEM Education Program.',
    ...
    },
    {
      ...
      sections: [
        {
          heading: "1st Place in the Air Force Research Lab's Challenge Comperition - Air Force Research Lab",
        },
        {
          heading: "Central New York's Best and Brightest - Syracuse Post Standard",
          
        },
        {
          heading: 'Xerox Award for Innovation and Technology - University of Rochester',
        ...
        {
          heading: "Admitted into Northwestern's Integrated Science Program - Northwestern Univeristy (40 out of 2,000 admitted)"
        },
        {
  ...
  function submitForm() {
    ...
    setResponse(`Name: ${firstName} ${lastName}\nEmail: ${email}\nSubject: ${subject}\nMessage: ${message}`);
  } 
  ...
  onMount(() => {
    ...
    const toggleExpansion = (element, to, duration = 1) => {
      return new Promise(resolve => {
        ...
        element.style.transition = 'width 1s ease-in-out, height 1s ease-in-out, left 1s ease-in-out, top 1s ease-in-out'
    ...
    const fadeOutAndRemove = (el, duration = 2.5) => {
      return new Promise((resolve) => {
        ...
        setTimeout(() => {el.remove(); resolve();}, duration * 1000);
      });
    }
    ...
    function loadShow () {
      ...
      for(var i = mainactive + 1; i < mainitems.length; i++) {
        stt++;
        mainitems[i].style.transform = `translateX(${300*stt}px) scale(${1 - 0.3*stt}) perspective(16px) rotateY(-1deg)`;
    ...
    mainnext.onclick = function() {
      mainactive = mainactive + 1 < mainitems.length ? mainactive + 1 : mainactive;
      loadShow()
    }
    ...
    /*Button fade In*/ 
    const coolButton = document.querySelectorAll('.coolButton1, .coolButton2, .skillslist');
      ...
      <div class="mainpage">
            ...
            <div class="rotatingimageslider" style="--quantity: 6">
              <div class="rotatingimageitem" style="--position: 1">
                <div class="rotatingimagecard">
                  <div class="cardexpansion1" onClick={() => OpenExpanded(0)}><img src="/LucidWakeProject.png" /></div>
                </div>
              </div>
        ...
        <div class='mainsectionscroller'>
          <div class="mainimageslider">
            ...
            <div class="nextButton">
              <svg xmlns="http://www.w3.org/2000/svg" height="50px" viewBox="0 -960 960 960" width="50px" fill="#e3e3e3"><path d="m321-80-71-71 329-329-329-329 71-71 400 400L321-80Z"/></svg>
            </div>
            <div class='previousButton'>
              <svg xmlns="http://www.w3.org/2000/svg" height="50px" viewBox="0 -960 960 960" width="50px" fill="#e3e3e3"><path d="M400-80 0-480l400-400 71 71-329 329 329 329-71 71Z"/></svg>
            </div>
        </div>
        ...
        <div class='contactsection' id='contact'>
          ...
          <form autocomplete='off' class='form' id='ContactForm' action="https://api.web3forms.com/submit" method='POST'>
            <input type="hidden" name="access_key" value="688916ba-e9bc-4002-971c-01a689db6701"></input>
            ...
            <label>
              <input type='subject' id='subject' name='subject' required></input>
            ...
            <div class='form-group'>
              <button type='button' onClick={submitForm}>See</button>
        ...
        <div class='linkSection'>
          ...
          <div class='linkContainer'>
            ...
            <ul>
              <li>
                <a href="https://www.linkedin.com/in/declan-reed-b30413379" target='_blank' rel='noopener noreferrer'>
                  <i class="fa fa-linkedin" aria-hidden="true"></i>
                  <span> - LinkdIn</span>
                </a>
              </li>
              <li>
                <a href="https://www.instagram.com/declan_354/" target='_blank' rel='noopener noreferrer'>
                  <i class="fa fa-instagram" aria-hidden="true"></i>
                  <span> - Instagram</span>
                </a>
              </li>
              <li>
                <a href="https://github.com/declanreed2029" target='_blank' rel='noopener noreferrer'>
