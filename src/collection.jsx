...
const collection = {
    1: {title: 'Python' , img1: '/LogoBackground/PhythonLogo1.png', img: '/Logo/PythonLogo.png', description: '-Numerous Certifications from Codeacademy \n -Used during the Air Force Research Lab Challenge Competition'},
    2: {title: 'Javascript' , img1: '/LogoBackground/JavascriptLogo1.png', img: '/Logo/JavascriptLogo.png', description: '-Used to build DeclanReed.net'},
    3: {title: 'CSS' , img1: '/LogoBackground/CSSLogo1.png', img: '/Logo/CSSLogo.png', description: '-Used to build DeclanReed.net'},
    4: {title: 'Laser Engraver' , img1: '/LogoBackground/LaserEngraverLogo1.png', img: '/Logo/LaserEngraverLogo.png', description: '-Certification from Segal Design Institute \n -Utilized in Personal Projects'},
    5: {title: 'HTML' , img1: '/LogoBackground/HTMLLogo1.png', img: '/Logo/HTMLLogo.png', description: '-Used to build DeclanReed.net'},
    6: {title: 'Solid' , img1: '/LogoBackground/SolidLogo1.png', img: '/Logo/SolidLogo.png', description: '-Framework used to build DeclanReed.net'},
    7: {title: 'Saws/Mills' , img1: '/LogoBackground/SawsMillsLogo1.png', img: '/Logo/SawsMillsLogo.png', description: '-Certification from Segal Design Institute \n -Utilized in Personal Projects'},
    8: {title: 'Java' , img1: '/LogoBackground/JavaLogo1.png', img: '/Logo/JavaLogo.png', description: '-Learned and used in AP CS \n -Used in Personal Projects'},
    9: {title: 'Blender' , img1: '/LogoBackground/BlenderLogo1.png', img: '/Logo/BlenderLogo.png', description: '-Used to create and render Images/Animations for DeclanReed.net'},
    10: {title: 'General Machinery' , img1: '/LogoBackground/GeneralMachineryLogo1.png', img: '/Logo/GeneralMachineryLogo.png', description: '-Certification from Segal Design Institute \n -Utilized in Personal Projects'},
    11: {title: 'NASA CEA' , img1: '/LogoBackground/NASACEALogo1.png', img: '/Logo/NASACEALogo.png', description: '-Used to calculate Mixture Ratios for the Propulsion Team'},
    12: {title: 'Fusion360' , img1: '/LogoBackground/Fusion360Logo1.png', img: '/Logo/Fusion360Logo.png', description: '-3D Design Projects \n -Syracuse University Astro-Bioengineering class \n -Jack Rover construction'},
    13: {title: 'OpenRocket' , img1: '/LogoBackground/OpenRocketLogo1.png', img: '/Logo/OpenRocketLogo.png', description: '-Used in early Rocket Propotype Construction at NU Stars'},
    14: {title: 'MotionOne' , img1: '/LogoBackground/MotionOneLogo1.png', img: '/Logo/MotionOneLogo.png', description: '-Used to create animations for DeclanReed.net'},
    15: {title: 'Vite' , img1: '/LogoBackground/ViteLogo1.png', img: '/Logo/ViteLogo.png', description: '-Framework used to build DeclanReed.net'},
};
const titleSVGs = {
...
async function loadInlineSvg(url) {
    ...
    if (!res.ok) {
        throw new Error(`Failed to load SVG from ${url}: ${res.status} ${res.statusText}`);
    }
...
export function getCollection() {
    ...
    function disablePreviewTilt() {
        ...
        if (activeSkillEl._previewTiltMove) {
            activeSkillEl.removeEventListener('mousemove', activeSkillEl._previewTiltMove);
            activeSkillEl._previewTiltMove = null;
        }
        if (activeSkillEl._previewTiltLeave) {
            activeSkillEl.removeEventListener('mouseleave', activeSkillEl._previewTiltLeave);
    ...
    async function togglePreview(index) {
        ...
        gsap.to(gallery, {
            ...
            duration: 2,
            ease: 'power4.inOut',
            onComplete: () => {isTransitioning = false; enablePreviewTilt();},
        });
    ...
    function resetGallery() {
        ...
        gsap.to(gallery, {
            ...
            onComplete: () => {
                ...
                document.querySelector('.coolButton2')?.classList.remove('fadeOut', 'done');
                document.querySelector('.skillslist')?.classList.remove('fadeOut', 'done');
