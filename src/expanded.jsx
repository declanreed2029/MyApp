      ...
      {(data) => {
        const HeroImage = (p) => (
          <div class="expandedHeroMedia">
            <div
              class={`projectImage ${p.data.imageMode === "morph" ? "morph" : "normal"}`}
            >
        ...
        return (
          ...
          >
            <section
              ...
              style={{
                "--bgImg": `url(${props.data.background})`,
                "--bgOverlay": props.data.overlay ?? "rgba(0,0,0,0.65)",
              }}
            >
              <button class="expandedClose" onClick={props.onClose}>
                X
              </button>
              <header class="expandedHero">
                {data().imagePlacement === "hero-left" && (
                  <HeroImage data={data()} />
                )}
                ...
                {data().imagePlacement === "hero-right" && (
                  <HeroImage data={data()} />
                )}
              </header>
              ...
              <div class="expandedMain">
                <div class="expandedLeft">
                  {data().imagePlacement === "left-sidebar" && (
                    <div
                      class={`projectImage ${data().imageMode === "morph" ? "morph" : "normal"}`}
                    >
